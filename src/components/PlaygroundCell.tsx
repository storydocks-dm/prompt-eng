...
export default function PlaygroundCell() {
  ...
  return (
    <div className="border-2 border-dashed border-stone-200 rounded-xl p-5 bg-stone-50">
      ...
      {response && (
        <div className="mt-3 bg-white border border-stone-200 rounded-lg p-3 max-h-64 overflow-y-auto prose prose-sm prose-stone max-w-none prose-pre:bg-stone-900 prose-pre:overflow-x-auto prose-code:text-xs">
